...
- La Home mostra chiaramente la versione **V.42**.
...
Corretto un problema di navigazione dal menu basso: in V.42 lo script poteva interrompersi perché cercava i pulsanti `prevMonthButton` e `nextMonthButton`, rimossi dalla Home. Ora i listener sono protetti e il menu basso cambia correttamente sezione.
...
Versione ricostruita sulla base stabile V.42.
...
- aggiunta migrazione da V.42/V.42 senza usare la logica instabile della V.42.


## Correzione V.42

Corretta la regressione della V.42:

- dichiarata correttamente la costante `APP_VERSION`;
- riallineata la chiave di salvataggio a `spese-pwa-locale-v20`;
- mantenuta la base stabile V.42/V.42;
