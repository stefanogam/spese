...
- La Home mostra chiaramente la versione **V.45**.
...
Corretto un problema di navigazione dal menu basso: in V.45 lo script poteva interrompersi perché cercava i pulsanti `prevMonthButton` e `nextMonthButton`, rimossi dalla Home. Ora i listener sono protetti e il menu basso cambia correttamente sezione.
...
Versione ricostruita sulla base stabile V.45.
...
- aggiunta migrazione da V.45/V.45 senza usare la logica instabile della V.45.


## Correzione V.45

Corretta la regressione della V.45:

- dichiarata correttamente la costante `APP_VERSION`;
- riallineata la chiave di salvataggio a `spese-pwa-locale-v20`;
- mantenuta la base stabile V.45/V.45;
