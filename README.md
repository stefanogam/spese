...
- La Home mostra chiaramente la versione **V.44**.
...
Corretto un problema di navigazione dal menu basso: in V.44 lo script poteva interrompersi perché cercava i pulsanti `prevMonthButton` e `nextMonthButton`, rimossi dalla Home. Ora i listener sono protetti e il menu basso cambia correttamente sezione.
...
Versione ricostruita sulla base stabile V.44.
...
- aggiunta migrazione da V.44/V.44 senza usare la logica instabile della V.44.


## Correzione V.44

Corretta la regressione della V.44:

- dichiarata correttamente la costante `APP_VERSION`;
- riallineata la chiave di salvataggio a `spese-pwa-locale-v20`;
- mantenuta la base stabile V.44/V.44;
